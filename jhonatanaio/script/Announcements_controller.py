...
class Announcements_controller:
    def load_announcements_label(self):
        try:
            ...
            url1_pixmap = self.get_pixmap('http://**************99/AIOServiceSTG/Images5S/Painel.png')
        ...
        try:
            ...
            url2_pixmap = self.get_pixmap('http://**************99/AIOServiceSTG/Images5S/Lean.png')
        ...
        try:
            ...
            url3_pixmap = self.get_pixmap('http://**************99/AIOServiceSTG/Images5S/Toolbox.png')
        ...
        try:
            ...
            url4_pixmap = self.get_pixmap('http://**************99/AIOServiceSTG/Images5S/Environment.png')
