...
"border: 10px")
        ...
        self.lbl_iconcracha.setGeometry(QtCore.QRect(1030, 630, 61, 61))
        ...
        self.lbl_insertbadge.setGeometry(QtCore.QRect(1010, 700, 161, 21))
        font = QtGui.QFont()
        ...
        self.lbl_value_workstation.setGeometry(QtCore.QRect(850, 350, 421, 31))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        ...
        self.lbl_workstation.setGeometry(QtCore.QRect(1035, 390, 51, 21))
        font = QtGui.QFont()
        font.setFamily("Inter UI")
        font.setPointSize(10)
        ...
        self.lbl_*******ogo = QtWidgets.QLabel(self.main_loginscreen)
        self.lbl_*******ogo.setGeometry(QtCore.QRect(10, 740, 71, 31))
        self.lbl_*******ogo.setStyleSheet("IMAGE: url(:/Img/*******MasterBrand_White.png);\n"
"background-color:rgb(72, 75, 218)")
        self.lbl_*******ogo.setText("")
        self.lbl_*******ogo.setObjectName("lbl_*******ogo")
        self.lbl_value_hostname = QtWidgets.QLabel(self.main_loginscreen)
        self.lbl_value_hostname.setGeometry(QtCore.QRect(850, 525, 421, 31))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        ...
        self.lbl_hostname.setGeometry(QtCore.QRect(1025, 560, 81, 21))
        font = QtGui.QFont()
        font.setFamily("Inter UI")
        font.setPointSize(10)
        ...
        self.lbl_value_nickname = QtWidgets.QLabel(self.main_loginscreen)
        self.lbl_value_nickname.setGeometry(QtCore.QRect(850, 440, 421, 31))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(16)
        font.setBold(True)
        ...
        self.lbl_value_nickname.setStyleSheet("color: rgb(45, 34, 94)")
        self.lbl_value_nickname.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_value_nickname.setObjectName("lbl_value_nickname")
        self.lbl_nickname = QtWidgets.QLabel(self.main_loginscreen)
        self.lbl_nickname.setGeometry(QtCore.QRect(1030, 475, 81, 21))
        font = QtGui.QFont()
        font.setFamily("Inter UI")
        font.setPointSize(10)
        self.lbl_nickname.setFont(font)
        self.lbl_nickname.setStyleSheet("color: rgb(116, 111, 138)")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_value_hostname.setText(_translate("MainWindow", "*******RASP333"))
