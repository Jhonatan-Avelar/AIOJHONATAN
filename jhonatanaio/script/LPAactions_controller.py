...
class LPAactions_controller():
    ...
    def LPAactions_functions(self, workstation_name):
        ...
        url_LPAactions = 'http://**************02/AIOService/Lpa/GetOpenActionsByPost/?parameters=' + workstation_name
    ...
    def redirect_LPAactions(self):
        url_LPAactions = 'http://**************01/LPAEletronico/lpa/GetOpenActionsByPost/' + self.workstation_namePP
