...
class Mount:
    ...
    def mountdir(self):
        ...
        try:
            ...
            p = subprocess.Popen('mount -t cifs -o username=BELRASP01,password=J@bilB3l01 //10.57.16.51/*******test/AIO/AIOGIT/AIO.Americas.BEL/Logs ' + self.path,shell=True,stdout=subprocess.PIPE, stderr=subprocess.PIPE,universal_newlines=True)
            p.wait()
