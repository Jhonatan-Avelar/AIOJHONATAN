                ...
                if (self.Read_ID != None and self.NonLogged_Window.Station.Enabled == 1 ): 
                    ...
                    if (self.Actual_ID != self.Read_ID):
                        try:
                            ...
                            LoginResponse = requests.post(url='http://**************99/RaspLoginAPI/Authentication/LoginByWorker',data={'HostName': self.host, 'Badge': self.Read_ID})
                    ...
                    if (cont_logout >= self.logout_limit):
                        ...
                        if (self.Actual_ID != None):
                            ...
                            try:
                                ...
                                LogoutResponse = requests.post(url='http://**************99/RaspLoginAPI/Authentication/Logout',data={'HostName': self.host, 'Badge': self.Actual_ID}) 
