...
class DirectLabor:
    ...
    def Setup(self, LoginResponse, hostname):
        ...
        # get used id
        baseUrl = "http://**************02/AIOService/Jmd/GetUserDetailsByRegistration/" + str(self.ID_trim)
    ...
    def load_avatar(self):
        baseurl = 'http://**************01/UserImage/' + self.ID_trim + '.jpg'

        try:
            url = urllib.request.urlopen(baseurl)
        except:
            url = urllib.request.urlopen('http://**************01/UserImage/Default.jpg')
