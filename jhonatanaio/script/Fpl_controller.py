...
# pega info dos documentos e adiciona em arrays para gerar widgets na janela
    def get_all_documents(self, flag):
        ...
        try:
            ...
            url_alldocs = 'http://*******m0mat81/ojt/api/Trainings?physicalWorkstationId='+ physicalWorkstationId +'&traineeRegistration=' + traineeRegistration
            print(url_alldocs)
...
class thread_vt(QThread):
            ...
            for attempts in range(60):
                ...
                if read != first_read and read != None:
                    try:
                        ...
                        url_validatedocs = 'http://*******m0mat81/ojt/ojt-service/trainings'
    ...
    def get_user_by_badge(self, badge):
        url_getuser = 'http://**************99.corp.*******.org/OJT/ojtws/Authentication/GetUserByBadge?badge=' + badge
